...
- A high-level conceptual specification is given as a part of the IDS Reference Architecture Model ([current version 3.0](https://internationaldataspaces.org/wp-content/uploads/IDS-Reference-Architecture-Model-3.0-2019.pdf) of 2019; see section 3.4).

- [Webinar of November 2018, giving a technical overview of the Information Model](https://www.youtube.com/watch?v=BYdsEpDGLOg)
